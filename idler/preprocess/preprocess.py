...
#video_frame_sample: 从视频中按时间间隔抽取帧
...
#extract_frame_for_each_video: 从每个视频文件中提取帧
...
#extract_frames: 提取多个视频文件的帧。
# def extract_frames(root_path="../avsbench_data/Multi-sources/ms3_data"):
def extract_frames(root_path="../avsbench_data/det"):
...
#extract_audio_wav: 提取多个视频文件的音频并保存为WAV文件
...
def extract_audio_wav(root_path="../avsbench_data/det", \
                      csv_path=r"F:\AVSBench-main\avsbench_data\det\det.csv"):
...
#extract_one_log_mel: 从WAV文件中提取log_mel特征并保存为Pickle文件。
def extract_one_log_mel(wav_base_path, lm_save_base_path, df_one_video):
    ...
    return wrong_list
#extract_audio_log_mel: 提取多个WAV文件的log_mel特征并保存为Pickle文件。
# def extract_audio_log_mel(root_path="../avsbench_data/Multi-sources/ms3_data",\
#                    csv_path="../avsbench_data/Multi-sources/ms3_meta_data.csv"):
def extract_audio_log_mel(root_path="../avsbench_data/det", \
                              csv_path=r"F:\AVSBench-main\avsbench_data\det\det.csv"):
