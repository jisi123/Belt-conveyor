...
def extract_frames(root_path="../data/det"):
...
def extract_audio_wav(root_path="../data/det", \
                      csv_path=r".\data\det\det.csv"):
...
def extract_audio_log_mel(root_path="../data/det", \
                              csv_path=r".\data\det\det.csv"):
